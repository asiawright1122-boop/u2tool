...
| `https://www.u2tool.com/en/tools/dice-roller/` | 3 clicks / 837 impressions | 0 clicks / 0 impressions | -3 clicks | Follow-up completed 2026-05-10: English copy now matches D4-D100 dice buttons, dice count, modifier, totals, history, and Clear History behavior; Roll button SVG rendering fixed. |
...
- Follow-up: `en/tools/dice-roller/` now describes the actual D4, D6, D8, D10, D12, D20, D100 buttons, dice count, modifier, individual rolls, totals, roll history, and Clear History UI, fixes Roll button SVG rendering, and guards against unsupported drop-down, settings/seed, saved-configuration, weighted-dice, or advanced-statistics claims.
