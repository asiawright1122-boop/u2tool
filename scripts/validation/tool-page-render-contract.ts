...
export const TOOL_PAGE_RENDER_MATRIX: ToolPageRenderExpectation[] = [
  ...
  },
  {
    locale: 'en',
    slug: 'iban-validator',
    reason: 'active-recovery P0 organic profile; locks the documented IBAN evidence block',
    expectedTitleIncludes: 'IBAN Checker',
    expectedDescriptionIncludes: 'MOD-97',
    expectedH1Includes: 'IBAN Validator',
    expectedCanonicalPath: '/en/tools/iban-validator/',
    expectedIndexable: true,
    expectedJsonLdTypes: ['Organization', 'WebSite', 'SoftwareApplication', 'HowTo', 'BreadcrumbList', 'FAQPage'],
    expectedToolCluster: 'online-calculator',
    minClusterGroups: 1,
  ...
  },
  {
    locale: 'en',
    slug: 'ical-parser',
    reason: 'active-recovery P0 organic profile; locks the documented VEVENT/RRULE evidence block',
    expectedTitleIncludes: 'iCal Parser',
    expectedDescriptionIncludes: 'RRULE',
    expectedH1Includes: 'iCal Parser',
