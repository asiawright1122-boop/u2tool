...
const checks = [
  ...
  { name: 'developer data formatters en', url: '/en/tools/developer-data-formatters/', expect: { status: 200 }, bodyMustInclude: 'Developer Data Formatters, Converters &amp; Validators' },
  ...
  { name: 'legacy nonlocalized ranking newest', url: '/tools/ranking/newest', expect: { status: [301, 302, 307, 308], locationEndsWith: '/en/tools/' } },
  ...
  { name: 'legacy nonlocalized category under tools slash', url: '/tools/category/text/', expect: { status: [301, 302, 307, 308], locationEndsWith: '/en/categories/text/' } },
