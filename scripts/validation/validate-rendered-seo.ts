...
const checks: RenderedSeoCheck[] = [
  ...
  },
  {
    ...
    bodyMustInclude: ['designed for quick browser-based workflows', '/en/compare/choose-jwt-tool/'],
    bodyMustNotInclude: [
  ...
  {
    name: 'Regex Tester content trust guard',
  ...
  {
    name: 'Timestamp Converter content trust guard',
  ...
  {
    name: 'Image to Base64 content trust guard',
