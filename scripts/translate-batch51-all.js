...
const BATCH51_TOOLS = [
  ...
  'tsconfig-generator', 'editorconfig-generator',
  'github-readme-generator', 'changelog-generator', 'license-generator',
  'rot13-encoder', 'caesar-cipher', 'vigenere-cipher',
  'checksum-verifier',
  'inflation-calculator', 'break-even-calculator', 'margin-calculator', 'markup-calculator',
  'hashtag-generator', 'email-signature-generator'
];
...
5. Keep technical terms (like Dockerfile, ESLint, etc.) in English
...
async function main() {
  console.log('🚀 批量翻译 Batch 51 工具到所有语言\n');
  ...
  for (const locale of TARGET_LOCALES) {
    ...
    for (const slug of BATCH51_TOOLS) {
      if (rateLimited) {
