/**
 * Inline SVG icon renderer for Lucide icons.
 * Returns raw SVG strings that work in both Astro (set:html) and Svelte ({@html}).
 * 
 * Uses a curated subset of Lucide icons mapped by name.
 * All icons use 24x24 viewBox with stroke-based rendering.
 */

// Map of icon name → SVG inner paths
...
Object.assign(iconPaths, {
  ...
  'candlestick-chart': '<path d="M9 5v4"/><rect width="4" height="6" x="7" y="9" rx="1"/><path d="M9 15v2"/><path d="M17 3v4"/><rect width="4" height="6" x="15" y="7" rx="1"/><path d="M17 13v3"/><path d="M3 3v18h18"/>',
  ...
  'gantt-chart': '<path d="M8 6h10"/><path d="M6 12h9"/><path d="M11 18h7"/><path d="M3 3v18h18"/>',
  ...
  'bar-chart-4': '<path d="M3 3v18h18"/><path d="M13 17V9"/><path d="M18 17V5"/><path d="M8 17v-3"/>',
  'bar-chart-horizontal': '<path d="M3 3v18h18"/><path d="M7 16h8"/><path d="M7 11h12"/><path d="M7 6h3"/>',
  'percent': '<line x1="19" x2="5" y1="5" y2="19"/><circle cx="6.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/>',
  'combine': '<rect width="8" height="8" x="2" y="2" rx="2"/><path d="M14 2c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2"/><path d="M20 2c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2"/><path d="M10 18H5c-1.7 0-3-1.3-3-3v-1"/><polyline points="7 21 10 18 7 15"/>',
  ...
  // New developer & utility icons
  'contrast': '<circle cx="12" cy="12" r="10"/><path d="M12 18a6 6 0 0 0 0-12z"/>',
  'file-x': '<path d="M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"/><path d="M14 2v5a1 1 0 0 0 1 1h5m-5.5 4.5l-5 5m0-5l5 5"/>',
  ...
  'package': '<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73zM12 22V12"/><path d="M3.29 7L12 12l8.71-5M7.5 4.27l9 5.15"/>',
  ...
  'calendar-search': '<path d="M16 2v4m5 5.75V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7.25M22 22l-1.875-1.875M3 10h18M8 2v4"/><circle cx="18" cy="18" r="3"/>',
  'file-digit': '<path d="M4 12V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"/><path d="M14 2v5a1 1 0 0 0 1 1h5m-10 8h2v6m-2 0h4"/><rect width="4" height="6" x="2" y="16" rx="2"/>',
  'wand-2': '<path d="m21.64 3.64l-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.2 1.2 0 0 0 1.72 0L21.64 5.36a1.2 1.2 0 0 0 0-1.72M14 7l3 3M5 6v4m14 4v4M10 2v2M7 8H3m18 8h-4M11 3H9"/>',
  'gem': '<path d="M6 3h12l4 6-10 13L2 9Z"/><path d="M11 3 8 9l4 13"/><path d="M13 3l3 6-4 13"/>',
  'check-square': '<path d="M21 10.556V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.344"/><path d="m9 11l3 3L22 4"/>',
  ...
  'settings-2': '<path d="M14 17h5M19 7h-9"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/>',
  'server-cog': '<path d="m10.852 14.772l-.383.923m2.679-.923a3 3 0 1 0-2.296-5.544l-.383-.923m2.679.923l.383-.923"/><path d="m13.53 15.696l-.382-.924a3 3 0 1 1-2.296-5.544m3.92 1.624l.923-.383m-.923 2.679l.923.383"/><path d="M4.5 10H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-.5m-15 4H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-.5M6 18h.01M6 6h.01m3.218 4.852l-.923-.383m.923 2.679l-.923.383"/>',
  'terminal': '<path d="m4 17l6-6l-6-6m8 8h8"/>',
  ...
  'database-zap': '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 12 2.84M21 5v3m0 4l-3 5h4l-3 5"/><path d="M3 12a9 3 0 0 0 11.59 2.87"/>',
  'ship': '<path d="M12 10.189V14m0-12v3m7 8V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v6"/><path d="M19.38 20A11.6 11.6 0 0 0 21 14l-8188-3639a2 2 0 0 0-1.624 0L3 14a11.6 11.6 0 0 0 2.81 7.76"/><path d="M2 21c.6.5 1.2 1 2.5 1s2.5-.5 3.5-1c1.2-.5 2.4-1 3.5-1s2.4.5 3.5 1c1.2.5 2.4 1 3.5 1s2.5-.5 3.5-1c.6-.5 1.2-1 2.5-1"/>',
  ...
  'history': '<path d="M3 12a9 9 0 1 0 9-9a9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5m4-1v5l4 2"/>',
  'file-search-2': '<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M4.268 21a2 2 0 0 0 1.727 1H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v3"/><circle cx="9" cy="15" r="4"/><path d="m17 21-4.3-4.3"/>',
  ...
  'database-plus': '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0 0 12 2.84"/><path d="M3 12a9 3 0 0 0 12 2.84"/><path d="M19 13v6"/><path d="M16 16h6"/><path d="M21 5v7.5"/>',
  'shield-alert': '<path d="M12 22C7 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1v7"/><path d="M12 8v4"/><path d="M12 16h.01"/>',
});

/**
 * Get an inline SVG string for a given icon name.
 * Returns a complete <svg> element that can be used with set:html (Astro) or {@html} (Svelte).
 * 
 * @param name - Lucide icon name (e.g., 'braces', 'lock', 'globe')
 * @param size - Icon size in pixels (default: 24)
 * @param className - Optional CSS class name
 * @returns Complete SVG string, or a fallback circle if icon not found
 */
export function getIconSvg(name: string, size: number = 24, className: string = ''): string {
  const paths = iconPaths[name];
  const classAttr = className ? ` class="${className}"` : '';
  
  if (!paths) {
    // Fallback: simple circle icon
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${classAttr}><circle cx="12" cy="12" r="10"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>`;
  }

  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${classAttr}>${paths}</svg>`;
}
