...
> = {
  en: {
    ...
    'convert-models': { title: 'Convert Data & Models', description: 'Move JSON, CSV, YAML, XML, TypeScript, language models, tables, and protobuf-ready data between formats.' },
  ...
  zh: {
    ...
    'convert-models': { title: '数据与模型转换', description: '在 JSON、CSV、YAML、XML、TypeScript、语言模型、表格和 protobuf 数据之间转换。' },
  ...
  ja: {
    ...
    'convert-models': { title: 'データとモデル変換', description: 'JSON、CSV、YAML、XML、TypeScript、各言語モデル、テーブル、protobuf 向けデータを変換します。' },
  ...
  ko: {
    ...
    'convert-models': { title: '데이터 및 모델 변환', description: 'JSON, CSV, YAML, XML, TypeScript, 언어 모델, 테이블, protobuf용 데이터를 변환합니다.' },
  ...
  es: {
    ...
    'convert-models': { title: 'Convertir Datos y Modelos', description: 'Convierte JSON, CSV, YAML, XML, TypeScript, modelos de lenguaje, tablas y datos para protobuf.' },
  ...
  pt: {
    ...
    'convert-models': { title: 'Converter Dados e Modelos', description: 'Converta JSON, CSV, YAML, XML, TypeScript, modelos de linguagem, tabelas e dados para protobuf.' },
  ...
  fr: {
    ...
    'convert-models': { title: 'Convertir Donnees et Modeles', description: 'Convertissez JSON, CSV, YAML, XML, TypeScript, modeles de langage, tableaux et donnees protobuf.' },
  ...
  de: {
    ...
    'convert-models': { title: 'Daten und Modelle Konvertieren', description: 'Konvertieren Sie JSON, CSV, YAML, XML, TypeScript, Sprachmodelle, Tabellen und protobuf-Daten.' },
  ...
  ru: {
    ...
    'convert-models': { title: 'Конвертация данных и моделей', description: 'Преобразуйте JSON, CSV, YAML, XML, TypeScript, модели языков, таблицы и данные для protobuf.' },
  ...
  ar: {
    ...
    'convert-models': { title: 'تحويل البيانات والنماذج', description: 'حوّل JSON و CSV و YAML و XML و TypeScript والنماذج والجداول وبيانات protobuf.' },
