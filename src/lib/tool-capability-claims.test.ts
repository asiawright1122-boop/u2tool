...
describe("assessToolCapabilityClaims", () => {
  ...
  it.each([
    ...
    ["ja", "このアプリケーションでクエリスクリプトを実行します。"],
    ["ja", "このアプリケーションでクエリ バッチを実行します。"],
    ...
    ["ko", "이 애플리케이션에서 쿼리 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 쿼리스크립트를 실행합니다."],
    ["ko", "이 애플리케이션에서 쿼리 배치를 실행합니다."],
  ...
  it.each([
    ...
    ["ja", "このアプリケーションでNoSQLクエリコードを実行します。"],
    ["ja", "このアプリケーションでＮｏＳＱＬクエリコードを実行します。"],
    ["ja", "このアプリケーションでnon-SQLコードを実行します。"],
    ["ja", "このアプリケーションでnon-SQLクエリバッチを実行します。"],
    ["ja", "このアプリケーションでnon - SQL クエリ バッチを実行します。"],
    ["ja", "このアプリケーションでｎｏｎ ‑ ＳＱＬクエリバッチを実行します。"],
    ["ja", "このアプリケーションでｎｏｎ－ＳＱＬコードを実行します。"],
    ["ja", "このアプリケーションで非SQLコードを実行します。"],
    ["ja", "このアプリケーションで非-SQLコードを実行します。"],
    ["ja", "このアプリケーションで非-SQLクエリスクリプトを実行します。"],
    ["ja", "このアプリケーションで非－ＳＱＬ クエリ スクリプトを実行します。"],
    ["ja", "このアプリケーションで非－ＳＱＬコードを実行します。"],
    ["ja", "このアプリケーションで非 – SQL スクリプトを実行します。"],
    ["ja", "このアプリケーションで非−SQLバッチを実行します。"],
    ["ja", "このアプリケーションで非ＳＱＬコードを実行します。"],
    ["ja", "このアプリケーションで非 ＳＱＬ スクリプトを実行します。"],
    ["ko", "이 애플리케이션에서 NoSQL 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 NoSQL 쿼리 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 ＮｏＳＱＬ쿼리코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 non-SQL 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 non-SQL 쿼리 배치를 실행합니다."],
    ["ko", "이 애플리케이션에서 ｎｏｎ − ＳＱＬ 쿼리배치를 실행합니다."],
    ["ko", "이 애플리케이션에서 ｎｏｎ－ＳＱＬ코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 비SQL 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 비-SQL 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 비-SQL 쿼리 스크립트를 실행합니다."],
    ["ko", "이 애플리케이션에서 비-SQL쿼리스크립트를 실행합니다."],
    ["ko", "이 애플리케이션에서 비－ＳＱＬ쿼리 스크립트를 실행합니다."],
    ["ko", "이 애플리케이션에서 비－ＳＱＬ 코드를 실행합니다."],
    ["ko", "이 애플리케이션에서 비 ‑ SQL 스크립트를 실행합니다."],
    ["ko", "이 애플리케이션에서 비−SQL배치를 실행합니다."],
    ["ko", "이 애플리케이션에서 비 SQL 스크립트를 실행합니다."],
  ...
  it.each([
    ...
    [
      "ja",
      "SQLクエリを分析し、NoSQLクエリコードをこのアプリケーションでクエリバッチを安全に実行します。",
    ],
    [
      "ko",
      "SQL 쿼리를 분석하고 NoSQL 쿼리 코드를 이 애플리케이션에서 쿼리 배치를 안전하게 실행합니다.",
    ],
  ] as const)(
  ...
  it.each([
    ...
    [
      "ja",
      "SQLクエリを分析し、クエリバッチをこのアプリケーションでNoSQLクエリコードを安全に実行します。",
    ],
    [
      "ko",
      "SQL 쿼리를 분석하고 쿼리 배치를 이 애플리케이션에서 NoSQL 쿼리 코드를 안전하게 실행합니다.",
    ],
  ] as const)(
