...
export const crawledNotIndexedContentRefreshToolSlugsByCategory: Partial<Record<ToolCategory, readonly string[]>> = {
  ...
  generators: ['license-generator', 'random-color-generator', 'wave-generator', 'css-clip-path-generator', 'table-of-contents-generator', 'fake-name-generator', 'css-grid-generator', 'mesh-gradient-generator', 'email-signature-generator'],
  ...
  text: ['typing-speed-test', 'char-frequency', 'strikethrough-text', 'text-cleaner', 'html-to-text', 'text-deduplicator'],
};
