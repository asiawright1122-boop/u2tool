...
export const crawledNotIndexedContentRefreshToolSlugsByCategory: Partial<Record<ToolCategory, readonly string[]>> = {
  ...
  encoding: ['ascii-table', 'json-flattener', 'data-uri'],
  finance: ['credit-card-validator', 'margin-calculator', 'vat-calculator'],
  fun: ['decision-wheel', 'dice-roller', 'love-calculator'],
  generators: ['html-table-generator', 'license-generator', 'random-color-generator', 'wave-generator', 'css-clip-path-generator', 'table-of-contents-generator', 'fake-name-generator', 'css-grid-generator', 'mesh-gradient-generator', 'email-signature-generator'],
...
export const organicRecoveryToolSlugsByCategory: Partial<Record<ToolCategory, readonly string[]>> = {
  ...
  development: ['api-tester', 'tsconfig-generator', 'sql-query-optimizer', 'merge-conflict-resolver', 'go-formatter', 'crc32-calculator', 'crontab-calendar', 'database-schema-visualizer'],
  encoding: ['video-to-base64', 'ascii-table', 'morse-code-player', 'hex-editor', 'json-flattener', 'data-uri'],
  finance: ['credit-card-validator', 'margin-calculator', 'vat-calculator'],
  fun: ['decision-wheel', 'dice-roller', 'love-calculator'],
  generators: ['html-table-generator', 'license-generator', 'random-color-generator', 'wave-generator', 'css-clip-path-generator', 'table-of-contents-generator', 'fake-name-generator', 'css-grid-generator', 'mesh-gradient-generator', 'email-signature-generator'],
