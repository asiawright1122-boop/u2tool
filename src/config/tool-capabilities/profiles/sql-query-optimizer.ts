  ...
  forbiddenClaims: [
    {
      ...
      pattern:
        /\b(?:native|localized)\s+(?:Russian|Chinese|Japanese|Korean|Spanish|Portuguese|French|German|Arabic)\s+(?:diagnostics?|findings?|explanations?)\b/iu,
    ...
    },
    {
      ...
      reason:
        "The analyzer formats SQL but never rewrites or applies changes automatically.",
    },
    {
