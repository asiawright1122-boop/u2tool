...
export const TEXT_TOOLS: Tool[] = [
  ...
  { slug: 'text-cleaner', category: 'text', icon: 'type', component: 'TextCleaner', popular: true },
  { slug: 'list-randomizer', category: 'text', icon: 'type', component: 'ListRandomizer' },
  { slug: 'html-to-text', category: 'text', icon: 'type', component: 'HtmlToText', popular: true },
  ...
  { slug: 'char-frequency', category: 'text', icon: 'type', component: 'CharFrequency', popular: true },
  ...
  { slug: 'strikethrough-text', category: 'text', icon: 'type', component: 'StrikethroughText', popular: true },
