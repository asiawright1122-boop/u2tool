...
export const GENERATORS_TOOLS: Tool[] = [
  ...
  { slug: 'youtube-tags-generator', category: 'generators', icon: 'hash', component: 'PopularUtilityTool', popular: true },
  { slug: 'tiktok-hashtag-generator', category: 'generators', icon: 'hash', component: 'PopularUtilityTool', popular: true },
  { slug: 'instagram-caption-generator', category: 'generators', icon: 'text', component: 'PopularUtilityTool', popular: true },
  { slug: 'linkedin-post-generator', category: 'generators', icon: 'file-text', component: 'PopularUtilityTool', popular: true },
  { slug: 'blog-title-generator', category: 'generators', icon: 'text', component: 'PopularUtilityTool', popular: true },
  { slug: 'product-description-generator', category: 'generators', icon: 'file-text', component: 'PopularUtilityTool', popular: true },
  { slug: 'email-preview-text-generator', category: 'generators', icon: 'text', component: 'PopularUtilityTool', popular: true },
  { slug: 'faq-generator', category: 'generators', icon: 'file-text', component: 'PopularUtilityTool', popular: true },
  { slug: 'seo-title-generator', category: 'generators', icon: 'file-text', component: 'PopularUtilityTool', popular: true },
  { slug: 'tweet-generator', category: 'generators', icon: 'text', component: 'PopularUtilityTool', popular: true },
];
