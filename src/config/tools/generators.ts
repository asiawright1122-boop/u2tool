...
export const GENERATORS_TOOLS: Tool[] = [
  ...
  { slug: 'random-generator', category: 'generators', icon: 'dice-5', component: 'RandomGenerator', popular: true },
  ...
  { slug: 'css-grid-generator', category: 'generators', icon: 'grid-3x3', component: 'CssGridGenerator', popular: true },
  ...
  { slug: 'random-color-generator', category: 'generators', icon: 'zap', component: 'RandomColorGenerator', popular: true },
  ...
  { slug: 'wave-generator', category: 'generators', icon: 'zap', component: 'WaveGenerator', popular: true },
  { slug: 'mesh-gradient-generator', category: 'generators', icon: 'zap', component: 'MeshGradientGenerator', popular: true },
  ...
  { slug: 'changelog-generator-advanced', category: 'generators', icon: 'zap', component: 'ChangelogGeneratorAdvanced', popular: true },
