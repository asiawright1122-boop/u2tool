...
export const DEVELOPMENT_TOOLS: Tool[] = [
  ...
  { slug: 'regex-visualizer', category: 'development', icon: 'eye', component: 'RegexVisualizer', popular: true },
  { slug: 'crontab-calendar', category: 'development', icon: 'calendar-days', component: 'CrontabCalendar', popular: true },
  { slug: 'screen-resolution-tester', category: 'development', icon: 'monitor', component: 'ScreenResolutionTester', popular: true },
  ...
  { slug: 'dead-code-analyzer', category: 'development', icon: 'code-2', component: 'DeadCodeAnalyzer', popular: true },
  ...
  { slug: 'merge-conflict-resolver', category: 'development', icon: 'code-2', component: 'MergeConflictResolver', popular: true },
