...
export const IMAGE_TOOLS: Tool[] = [
  ...
  { slug: 'barcode-generator', category: 'image', icon: 'image', component: 'BarcodeGenerator', popular: true },
  ...
  { slug: 'image-collage', category: 'image', icon: 'image', component: 'ImageCollage', popular: true },
  ...
  { slug: 'pixel-density-calculator', category: 'image', icon: 'image', component: 'PixelDensityCalculator', popular: true },
