    ...
    <div className="max-w-4xl mx-auto px-4 py-12 min-h-screen">
      ...
      <div className="space-y-8 text-gray-700 dark:text-gray-300">
        ...
        <section className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700/50">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('useOfService.title')}</h2>
          <p>{t('useOfService.content')}</p>
        </section>

        <section className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700/50">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('disclaimer.title')}</h2>
          <p>{t('disclaimer.content')}</p>
        </section>

        <section className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700/50">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('limitations.title')}</h2>
          <p>{t('limitations.content')}</p>
        </section>

        <section className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700/50">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('intellectualProperty.title')}</h2>
          <p>{t('intellectualProperty.content')}</p>
        </section>

        <section className="bg-gray-100 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700/50">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('prohibited.title')}</h2>
