    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">{t('text')}</label>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <label className="block text-sm text-gray-300 mb-2">{t('color1')}</label>
              <input type="color" value={color1} onChange={(e) => setColor1(e.target.value)}
                className="w-full h-10 rounded cursor-pointer" />
            </div>
            <div>
              <label className="block text-sm text-gray-300 mb-2">{t('color2')}</label>
              <input type="color" value={color2} onChange={(e) => setColor2(e.target.value)}
                className="w-full h-10 rounded cursor-pointer" />
            </div>
            <div>
              <label className="block text-sm text-gray-300 mb-2">{t('color3')}</label>
          ...
          <div>
            <label className="block text-sm text-gray-300 mb-2">{t('angle')}: {angle}°</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-gray-300 mb-2">{t('fontSize')}: {fontSize}px</label>
              <input type="range" min="16" max="120" value={fontSize}
                onChange={(e) => setFontSize(parseInt(e.target.value))} className="w-full" />
            </div>
            <div>
              <label className="block text-sm text-gray-300 mb-2">{t('fontWeight')}: {fontWeight}</label>
        ...
        <div className="space-y-4">
          <div className="bg-gray-700 rounded-lg p-8 flex items-center justify-center min-h-[200px]">
            <span style={{
              background: getGradient(),
          ...
          <div>
            ...
            <pre className="bg-gray-700 rounded-lg p-4 font-mono text-sm text-green-400 overflow-x-auto">{getCss()}</pre>
          </div>
