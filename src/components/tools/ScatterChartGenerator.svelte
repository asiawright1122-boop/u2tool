<script lang="ts">
  ...
  function t(key: string): string {
    ...
    return typeof value === 'string' ? value : `MISSING: tools.scatter-chart-generator.${key}`;
  }
  ...
  function updatePoint(seriesIndex: number, pointId: string, field: 'x' | 'y', value: number) {
    const newSeries = [...series];
