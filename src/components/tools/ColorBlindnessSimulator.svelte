  ...
  function getFilterStyle(type: ColorBlindnessType): Record<string, string> {
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label for="color-blindness-simulator-field-4" class="tool-label">
            {t('selectColor')}
          </label>
          <div class="flex gap-3">
            <input
              type="color"
              bind:value={color}
              class="w-16 h-12 rounded cursor-pointer" id="color-blindness-simulator-field-4" />
            <input
              type="text"
              bind:value={color}
        ...
        <div>
          <label for="color-blindness-simulator-field-3" class="tool-label">
            {t('uploadImage')}
          </label>
          <input
            type="file"
            ...
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white" id="color-blindness-simulator-field-3" />
        </div>
      </div>
