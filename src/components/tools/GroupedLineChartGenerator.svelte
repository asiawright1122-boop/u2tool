<script lang="ts">
  ...
  const t = createToolTranslator(translations, 'grouped-line-chart-generator');
          ...
          <div>
            ...
            <div class="space-y-3 p-4 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <div class="flex flex-wrap gap-6 text-sm">
                ...
                <label class="flex items-center gap-2 cursor-pointer"><input type="checkbox" bind:checked={smooth} class="w-4 h-4 accent-amber-500" /><span>{t('smooth')}</span></label>
              </div>
            </div>
          </div>
