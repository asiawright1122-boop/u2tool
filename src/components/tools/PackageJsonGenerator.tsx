  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-sm text-gray-300 mb-1">{t('version')}</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm text-gray-300 mb-1">{t('main')}</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm text-gray-300 mb-1">{t('author')}</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm text-gray-300 mb-1">{t('license')}</label>
          <select
        ...
        <div>
          <label className="block text-sm text-gray-300 mb-1">{t('type')}</label>
          <select
      ...
      <div>
        <label className="block text-sm text-gray-300 mb-1">{t('keywords')}</label>
        <input
          type="text"
          value={keywords}
      ...
      {/* Scripts */}
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">{t('scripts')}</label>
        ...
        <div className="flex flex-wrap gap-2">
          <span className="text-sm text-gray-300">{t('commonScripts')}:</span>
      ...
      {output && (
        <div>
          <div className="flex justify-between items-center mb-2">
            <label className="text-sm font-medium text-gray-300">package.json</label>
          ...
          <textarea
            value={output}
            readOnly
            className="w-full h-64 bg-gray-800 border border-gray-700 rounded-lg p-4 font-mono text-sm resize-none"
          />
        </div>
      )}
    </div>
