<script lang="ts">
    ...
    function t(key: string, vars?: Record<string, string | number>): string {
        ...
        const scope = tools["venn-diagram-generator"] || {};
        ...
        if (typeof value !== "string")
            return `MISSING: tools.venn-diagram-generator.${key}`;
    ...
    const activeSets = $derived(getVisibleSets());
    function updateSet(
        index: number,
        field: keyof VennSet,
        value: string | number,
...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="space-y-4">
            ...
            <div class="space-y-3">
                <h3 class="text-sm font-medium text-gray-700 dark:text-white">
                    {t("dataEditor")}
                </h3>
                {#each activeSets as set, index (index)}
                    <div
                        class="p-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg space-y-2"
                    >
                        ...
                        <input
                            ...
                            value={set.label}
                            onchange={(e) =>
                                updateSet(index, "label", e.target.value)}
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input
                                ...
                                value={set.color}
                                onchange={(e) =>
                                    updateSet(index, "color", e.target.value)}
        ...
        <div>
            ...
            <div
                class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex justify-center overflow-auto"
            >
                <svg
                    bind:this={svgRef}
                    width="600"
    ...
    <div
        class="p-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg text-sm text-amber-700 dark:text-amber-300 mt-4"
    >
