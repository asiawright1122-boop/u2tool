...
export default function TreeChartGenerator() {
    ...
    }, [nodes, chartTitle, colorTheme, layout, orient, buildTree]);
                    ...
                    <div>
                        ...
                        <div className="max-h-[500px] overflow-y-auto border border-gray-700 rounded-lg">
                            <table className="w-full text-sm text-left text-gray-400">
                                ...
                                <tbody>
                                    {nodes.map((node) => (
                                        <tr key={node.id} className="bg-gray-800 border-b border-gray-700 hover:bg-gray-700">
                                            ...
                                            <td className="px-2 py-2">
                                                <select
                                                    ...
                                                    className="bg-gray-900 border border-gray-600 text-xs rounded p-1 w-full max-w-[100px]"
