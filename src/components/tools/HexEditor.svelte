  ...
  async function copy(val: string) {
    ...
    <div class="space-y-4">
      <div class="grid md:grid-cols-2 gap-4">
        <div>
          <label for="hex-editor-field-4" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">{t('hexEditor.text')}</label>
          <textarea bind:value={text} class="w-full h-40 p-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg font-mono text-sm text-gray-900 dark:text-white" placeholder={t('inputPlaceholder')} id="hex-editor-field-4"></textarea>
        ...
        <div>
          <label for="hex-editor-field-3" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">{t('hexEditor.hex')}</label>
          <textarea bind:value={hex} class="w-full h-40 p-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg font-mono text-sm text-gray-900 dark:text-white" placeholder="48 65 6C 6C 6F" id="hex-editor-field-3"></textarea>
          <div class="flex gap-2 mt-2">
