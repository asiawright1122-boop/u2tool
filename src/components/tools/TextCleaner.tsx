      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-sm font-medium text-gray-300">{t('input')}</label>
              <button
                onClick={() => setInput('')}
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-sm font-medium text-gray-300">{t('cleanedText')}</label>
              <button
        ...
        <div className="space-y-4">
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            <h3 className="text-lg font-semibold mb-4 text-white">{t('options')}</h3>
            <div className="space-y-3">
              <label className="flex items-center space-x-3 cursor-pointer">
                ...
                />
                <span className="text-gray-300 text-sm">{t('trimLines')}</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                />
                <span className="text-gray-300 text-sm">{t('removeEmptyLines')}</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                />
                <span className="text-gray-300 text-sm">{t('removeDuplicateLines')}</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                />
                <span className="text-gray-300 text-sm">{t('removeExtraSpaces')}</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                />
                <span className="text-gray-300 text-sm">{t('removeHtmlTags')}</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                />
                <span className="text-gray-300 text-sm">{t('removePunctuation')}</span>
              </label>
              <div className="pt-2 border-t border-gray-700">
                <label className="flex items-center space-x-3 cursor-pointer mb-2">
                  <input
                    ...
                    className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                  />
                  <span className="text-gray-300 text-sm">{t('lowercase')}</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    className="form-checkbox h-4 w-4 text-blue-600 rounded bg-gray-700 border-gray-600"
                  />
                  <span className="text-gray-300 text-sm">{t('uppercase')}</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 rounded-xl border border-gray-700">
             <div className="text-sm text-gray-300">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-white">{output.length}</span>
                </div>
                <div className="flex justify-between">
                  <span>{t('lines')}:</span>
                  <span className="text-white">{output ? output.split('\n').length : 0}</span>
                </div>
             </div>
          </div>
        </div>
