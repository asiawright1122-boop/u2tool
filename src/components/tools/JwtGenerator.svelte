...
{/if}
      ...
      <div class="p-4 bg-gray-100 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg text-sm">
        ...
        <div class="grid grid-cols-2 gap-2 text-gray-600 dark:text-gray-300">
          <div><code class="text-blue-400">iss</code> - {t('jwt.claims.iss')}</div>
          <div><code class="text-blue-400">sub</code> - {t('jwt.claims.sub')}</div>
          <div><code class="text-blue-400">aud</code> - {t('jwt.claims.aud')}</div>
          <div><code class="text-blue-400">exp</code> - {t('jwt.claims.exp')}</div>
          <div><code class="text-blue-400">nbf</code> - {t('jwt.claims.nbf')}</div>
          <div><code class="text-blue-400">iat</code> - {t('jwt.claims.iat')}</div>
          <div><code class="text-blue-400">jti</code> - {t('jwt.claims.jti')}</div>
        </div>
      </div>
    </div>
