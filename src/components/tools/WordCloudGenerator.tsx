...
export default function WordCloudGenerator() {
  ...
  }, [chartTitle, colorTheme, shape, minFontSize, maxFontSize, rotationRange, words, chartTheme]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto p-2 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
