...
export default function StackedBarChartGenerator() {
  const t = useTranslations('tools.stacked-bar-chart-generator');
  ...
  }, [categories, series, chartTitle, colorTheme, showLegend, showGrid, horizontal, chartTheme.backgroundColor, chartTheme.textColor, chartTheme.legendText, chartTheme.splitLineColor, chartTheme.axisLineColor, chartTheme.axisLabelColor]);
