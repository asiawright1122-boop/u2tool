...
{/if}
      ...
      <div>
        <label for="vcard-parser-field-2" class="block text-sm text-gray-600 dark:text-gray-300 mb-2">{t('vcardContent')}</label>
        <textarea
          bind:value={input}
          ...
          placeholder={t('inputPlaceholder')} id="vcard-parser-field-2"></textarea>
      </div>
