<script lang="ts">
  ...
  function sortLines() {
    ...
    <div class="space-y-4">
      ...
      <div>
        <label for="line-counter-field-2" class="block text-sm text-gray-600 dark:text-gray-300 mb-2">{tg('input')}</label>
        <textarea
          bind:value={input}
          ...
          placeholder={t('placeholder')} id="line-counter-field-2"></textarea>
      </div>
    </div>
