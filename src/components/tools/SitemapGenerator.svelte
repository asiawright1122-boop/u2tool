...
${urls.map(url => `  <url>
    <loc>${escapeXml(formatLocation(url.loc))}</loc>
...
<div  class="grid grid-cols-12 gap-2 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-2">
              <input type="text" value={url.loc} oninput={(e) => updateUrl(index, 'loc', (e.currentTarget as HTMLInputElement).value)}
                ...
                placeholder="/path" />
              <input type="date" value={url.lastmod} oninput={(e) => updateUrl(index, 'lastmod', (e.currentTarget as HTMLInputElement).value)}
              ...
              <select value={url.changefreq} onchange={(e) => updateUrl(index, 'changefreq', (e.currentTarget as HTMLSelectElement).value)}
                class="col-span-2 px-2 py-1 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded text-gray-900 dark:text-white text-sm">
              ...
              <select value={url.priority} onchange={(e) => updateUrl(index, 'priority', (e.currentTarget as HTMLSelectElement).value)}
                class="col-span-2 px-2 py-1 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded text-gray-900 dark:text-white text-sm">
