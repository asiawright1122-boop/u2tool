  ...
  function formatDate(date: Date) {
    ...
    <div class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label for="age-birth-date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            {t('birthDate')}
          </label>
          <input
            id="age-birth-date"
        ...
        <div>
          <label for="age-reference-date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            {t('referenceDate')}
          </label>
          <input
