<script lang="ts">
  ...
  function formatCurrency(value: number) {
    ...
    <div class="space-y-6">
      <div>
        <label for="tip-bill-amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          {t('billAmount')}
        </label>
        <input
          id="tip-bill-amount"
      ...
      <div>
        <label for="tip-percentage" class="tool-label">
          {t('tipPercentage')}
        </label>
...
{/each}
      ...
      <div>
        <label for="tip-split-count" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          {t('splitCount')}
        </label>
