<script lang="ts">
  ...
  function t(key: string): string {
    ...
    return typeof value === 'string' ? value : `MISSING: tools.treemap-chart-generator.${key}`;
  }
  ...
  function updateNode(nodeId: string, field: 'name' | 'value', value: string | number) {
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-3 max-h-80 overflow-y-auto">
              <div class="flex items-center gap-2 py-1 border-b border-gray-200 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400 font-medium">
