  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-2">
            <div>
              <label for={t("upColor")} class="block text-sm font-medium mb-1"
                >{t("upColor")}</label
              >
              <input
                type="color"
            ...
            <div>
              <label for={t("downColor")} class="block text-sm font-medium mb-1"
                >{t("downColor")}</label
              >
              <input
                type="color"
      ...
      <div>
        ...
        <div
          class="max-h-64 overflow-auto p-2 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg"
        >
          <div class="min-w-[600px] space-y-2">
            <div
              class="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_auto] gap-1 text-xs text-gray-500 dark:text-gray-400 px-1"
            >
              <span>{t("date")}</span>
              <span>{t("open")}</span>
              <span>{t("close")}</span>
            ...
            {#each data as item, index (index)}
              <div
                class="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_auto] gap-1 items-center"
              >
                <input
                  type="date"
                  value={item.date}
