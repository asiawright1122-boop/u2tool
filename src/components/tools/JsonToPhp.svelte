  ...
  function copyToClipboard() {
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <label for="json-to-php-field-4" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">{t('input')}</label>
          <textarea bind:value={input}
            ...
            placeholder={t('inputPlaceholder')} id="json-to-php-field-4"></textarea>
        </div>
        <div>
          <label for="json-to-php-field-3" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">{t('output')}</label>
          <textarea value={output} readOnly
            ...
            placeholder={t('outputPlaceholder')} id="json-to-php-field-3"></textarea>
        </div>
      </div>
