...
{/snippet}
    ...
    <div class="space-y-6">
      <div class="flex items-center gap-4">
        <label for="chmod-calculator-field-2" class="text-sm font-medium text-gray-900 dark:text-white">{t('chmod.octal')}:</label>
        <input type="text" bind:value={octal} maxLength={3} class="w-24 px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded font-mono text-xl text-center text-gray-900 dark:text-white" id="chmod-calculator-field-2" />
