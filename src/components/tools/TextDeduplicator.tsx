    ...
    <div className="space-y-4">
      <div className="flex gap-4 flex-wrap items-center">
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm text-gray-600 dark:text-gray-300">{t('caseSensitive')}</span>
        </label>
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600"
          />
          <span className="text-sm text-gray-600 dark:text-gray-300">{t('trimLines')}</span>
        </label>
        <button
          onClick={copyResult}
          disabled={!result.output}
          className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 rounded-lg transition-colors text-white"
        >
          {tg('copy')}
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
          <div className="text-xl font-bold text-blue-600 dark:text-blue-400">{result.original}</div>
          <div className="text-sm text-gray-600 dark:text-gray-300">{t('original')}</div>
        </div>
        <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
          <div className="text-xl font-bold text-green-600 dark:text-green-400">{result.unique}</div>
          <div className="text-sm text-gray-600 dark:text-gray-300">{t('unique')}</div>
        </div>
        <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-center">
          <div className="text-xl font-bold text-red-600 dark:text-red-400">{result.removed}</div>
          <div className="text-sm text-gray-600 dark:text-gray-300">{t('removed')}</div>
        </div>
      </div>
