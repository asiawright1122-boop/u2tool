...
export default function PercentageStackedBarChartGenerator() {
  ...
  }, [data, seriesNames, chartTitle, colorTheme, showLegend, horizontal, chartTheme.backgroundColor, chartTheme.textColor, chartTheme.legendText, chartTheme.splitLineColor, chartTheme.axisLineColor, chartTheme.axisLabelColor]);
