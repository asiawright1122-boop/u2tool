    ...
    <div className="space-y-4">
      <div className="flex gap-2">
        <button
          ...
          className={`px-4 py-2 rounded ${mode === 'encrypt' ? 'bg-blue-600' : 'bg-gray-700'}`}
        >
          {t('encryption.encrypt')}
        </button>
        <button
          onClick={() => setMode('decrypt')}
          className={`px-4 py-2 rounded ${mode === 'decrypt' ? 'bg-blue-600' : 'bg-gray-700'}`}
        >
      ...
      <div>
        <label className="block text-sm text-gray-300 mb-1">{t('encryption.password')}</label>
        <input
          type="password"
          value={password}
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full h-32 bg-gray-800 rounded p-3 text-white font-mono text-sm"
