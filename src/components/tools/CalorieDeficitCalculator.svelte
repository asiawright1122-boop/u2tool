...
<div class="tool-theme-shell p-6 rounded-2xl font-sans min-h-[400px]">
  ...
  <div class="flex items-center gap-3 mb-6">
    ...
    <div>
      <h2 class="font-extrabold text-lg text-orange-700 dark:bg-gradient-to-r dark:from-orange-300 dark:via-orange-100 dark:to-orange-400 dark:bg-clip-text dark:text-transparent leading-tight">
        {l.title}
      </h2>
