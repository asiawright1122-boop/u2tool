      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <Link
                      ...
                      className="flex items-center justify-between px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800 transition-colors"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={searchRef}>
            <div className="relative">
              <input
                ...
                className="w-40 sm:w-48 lg:w-56 px-4 py-2 pl-10 bg-gray-800 border border-gray-700 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
              />
          ...
          <div className="relative group">
            <button className="flex items-center gap-1 px-3 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute right-0 top-full mt-1 w-36 bg-gray-800 border border-gray-700 rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all shadow-xl">
              {locales.map((locale) => (
                <button
                  key={locale}
              ...
              {categories.map((cat) => {
                ...
                return (
                  <Link
                    key={cat.id}
                    href={`/tools?category=${cat.id}`}
                    className="flex items-center justify-between px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg"
                    onClick={() => setMobileMenuOpen(false)}
                  >
