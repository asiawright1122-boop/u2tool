...
# Phase 95: TDK Cleanup Batch Three - Plan

This phase opens v0.0.35. It continues the candidate-driven cleanup process with
a third small, synchronized metadata batch.
...
- `es/code-duplication-finder`
- `es/swagger-to-code-generator`
- `es/gradient-generator`
- `es/image-resizer`
- `fr/invoice-template-generator`
- `fr/meeting-minutes-generator`
- `pt/performance-profiler`
- `pt/base58`
- `pt/project-risk-analyzer`
- `es/json-to-protobuf-converter`
...
Expected: PASS with `0` errors, `2772` warnings, and `30` cleanup candidates.
...
- TDK integrity PASS with `0` errors and `2762` warnings.
- Traceability maps all 6 v0.0.35 requirements to Phase 95.
- SEO governance, Astro check, and build remain green.

## Verification

Final evidence should be recorded in
`.planning/phases/95-tdk-cleanup-batch-three/95-BASELINE.md` and
`.planning/milestones/v0.0.35-MILESTONE-AUDIT.md`.
