...
- [ ] **RUNTIME-04**: User-facing meeting and time scheduling tools compute timezone conversions, working-hour windows, availability slots, and conflicts through shared runtime-integrity helpers instead of empty `tool-stubs.ts` exports or component-local duplicated algorithms.
