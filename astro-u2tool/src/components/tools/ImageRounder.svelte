...
{/if}
          ...
          <button
            ...
            disabled={!image}
            class="w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed rounded-lg"
          >
            {tg('download')} PNG
          </button>
        </div>
