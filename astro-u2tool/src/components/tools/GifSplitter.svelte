...
<div class="space-y-4">
              <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                  ...
                  <button onclick={deselectAll} class="text-sm text-blue-600 hover:underline">
                    {t('deselectAll')}
                  </button>
                </div>
              </div>
...
<div 
                  ...
                  >
                    ...
                    {#if selectedFrames.includes(frame.index)}<span class="absolute top-0 right-0 bg-blue-500 text-white text-xs px-1">
                        ✓
                      </span>{/if}
                  </div>
{/each}
